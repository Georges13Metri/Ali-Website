    ...
    <div>
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute top-1/2 left-0 transform -translate-y-1/2 px-8 max-w-xl">
          <h1 className="text-4xl text-black md:text-5xl lg:text-6xl font-bold mb-2">
            PERSONAL TRAINING
          </h1>
      ...
      <div className=" flex justify-center bg-white items-center">
        <div className="flex mt-20 flex-col mx-auto">
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 w-3/4 
          mx-auto px-5 py-5 text-black"
          >
            <div>
              <Image
                width={100}
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 w-full md:w-1/2 mx-auto flex flex-col justify-center items-center text-center md:text-right px-8">
          ...
          <p className="text-white text-xs md:text-sm mb-6 md:mb-10">
            ...
            and sustainable forever{" "}
            <span className="font-bold">so they can..</span>
          </p>
          <ul className="text-white text-xs md:text-sm mb-6 md:mb-10 text-left">
            <li>
              <span>
                ✓ Feel confident and attractive around their friends, family,
                and out in public
              </span>
            </li>
            <li>
              <span>
                ✓ Feel Physically & mentally strong, capable of taking on any
                challenge without worrying that their energy levels or body
                weight will get in the way.
              </span>
            </li>
            <li>
            ...
            <li>
              <span>✓ Add 10+ years of healthy living to their retirement</span>
            </li>
          </ul>
      ...
      lg:grid-cols-2 gap-8 p-4 md:p-8  items-center"
      >
        ...
        <div className="flex flex-col justify-center mt-20 text-black">
